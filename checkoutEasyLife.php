     ...
     <div class="container-1">
          <div class="product">
               <div class="product-shirt">
                    <img src="asset/Easy Life.png" alt="">
               </div>
               <div class="product-shirt-1">
                    <img src="asset/Easy Life Depan.png"><br>
                    <img src="asset/Easy Life Belakang.png">
               </div>
               <div class="product-price">
                    <h3>Lixie T-Shirt Easy Life</h3>
                    <h4>Rp 135.000</h4>
