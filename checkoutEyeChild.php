     ...
     <div class="container-1">
          <div class="product">
               <div class="product-shirt">
                    <img src="asset/eye child.png" alt="">
               </div>
               <div class="product-shirt-1">
                    <img src="asset/black-shirt-front.png"><br>
                    <img src="asset/black-shirt-back.png">
               </div>
               <div class="product-price">
                    <h3>Lixie T-Shirt Eye Child</h3>
                    <h4>Rp 135.000</h4>
